      ...
      {:content [
       ...
       :meta {:uid package.uid
              ...
              :action (match package.action
                        ...
                        ;; staged but paret unstaged and need to show the
  ...
  (fn decomp-line [line]
    ...
    (-> (E.map #(decomp-column $2) line.content)
        ...
        (#(if (?. line :meta :uid)
            ...
            $1))
        (#(if (?. line :meta :health)
            (E.append$ $1 {:health line.meta.health})
            $1))
        (#(if (?. line :meta :workflow)
            (E.append$ $1 {:workflow line.meta.workflow})
            $1))
        (#(if (?. line :meta :action)
            (E.append$ $1 {:action line.meta.action})
            $1))
       ))
