 ...
 local __fn_2a_satisfies_3f_dispatch = {bodies = {}, help = {}} local satisfies_3f local function _43_(...) if (0 == #(__fn_2a_satisfies_3f_dispatch).bodies) then error(("multi-arity function " .. "satisfies?" .. " has no bodies")) else end local _45_ do local f_74_auto = nil for __75_auto, match_3f_76_auto in ipairs((__fn_2a_satisfies_3f_dispatch).bodies) do if f_74_auto then break end f_74_auto = match_3f_76_auto(...) end _45_ = f_74_auto end if (nil ~= _45_) then local f_74_auto = _45_ return f_74_auto(...) elseif (_45_ == nil) then local view_77_auto do local _46_, _47_ = pcall(require, "fennel") if ((_46_ == true) and ((_G.type(_47_) == "table") and (nil ~= (_47_).view))) then local view_77_auto0 = (_47_).view view_77_auto = view_77_auto0 elseif ((_46_ == false) and true) then local __75_auto = _47_ view_77_auto = (_G.vim.inspect or print) else view_77_auto = nil end end local msg_78_auto local _49_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_79_auto = 1, select("#", ...) do local val_19_auto = view_77_auto(({...})[i_79_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _49_ = tbl_17_auto end msg_78_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "satisfies?", table.concat(_49_, ", "), table.concat((__fn_2a_satisfies_3f_dispatch).help, "\n")) return error(msg_78_auto) else return nil end end satisfies_3f = _43_ local function _52_() local function _53_() table.insert((__fn_2a_satisfies_3f_dispatch).help, "(where [spec ver] (and (valid-version-spec? spec) (valid-version? ver)))") local function _54_(...) if (2 == select("#", ...)) then local _55_ = {...} local function _56_(...) local spec_41_ = (_55_)[1] local ver_42_ = (_55_)[2] return (valid_version_spec_3f(spec_41_) and valid_version_3f(ver_42_)) end if (((_G.type(_55_) == "table") and (nil ~= (_55_)[1]) and (nil ~= (_55_)[2])) and _56_(...)) then local spec_41_ = (_55_)[1] local ver_42_ = (_55_)[2] local function _57_(spec, ver)
 ...
 local __fn_2a_solve_dispatch = {bodies = {}, help = {}} local solve local function _66_(...) if (0 == #(__fn_2a_solve_dispatch).bodies) then error(("multi-arity function " .. "solve" .. " has no bodies")) else end local _68_ do local f_74_auto = nil for __75_auto, match_3f_76_auto in ipairs((__fn_2a_solve_dispatch).bodies) do if f_74_auto then break end f_74_auto = match_3f_76_auto(...) end _68_ = f_74_auto end if (nil ~= _68_) then local f_74_auto = _68_ return f_74_auto(...) elseif (_68_ == nil) then local view_77_auto do local _69_, _70_ = pcall(require, "fennel") if ((_69_ == true) and ((_G.type(_70_) == "table") and (nil ~= (_70_).view))) then local view_77_auto0 = (_70_).view view_77_auto = view_77_auto0 elseif ((_69_ == false) and true) then local __75_auto = _70_ view_77_auto = (_G.vim.inspect or print) else view_77_auto = nil end end local msg_78_auto local _72_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_79_auto = 1, select("#", ...) do local val_19_auto = view_77_auto(({...})[i_79_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _72_ = tbl_17_auto end msg_78_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "solve", table.concat(_72_, ", "), table.concat((__fn_2a_solve_dispatch).help, "\n")) return error(msg_78_auto) else return nil end end solve = _66_ local function _75_() local _76_ do table.insert((__fn_2a_solve_dispatch).help, "(where [spec versions] (and (valid-version-spec? spec) (table? versions)))") local function _77_(...) if (2 == select("#", ...)) then local _78_ = {...} local function _79_(...) local spec_62_ = (_78_)[1] local versions_63_ = (_78_)[2] return (valid_version_spec_3f(spec_62_) and table_3f(versions_63_)) end if (((_G.type(_78_) == "table") and (nil ~= (_78_)[1]) and (nil ~= (_78_)[2])) and _79_(...)) then local spec_62_ = (_78_)[1] local versions_63_ = (_78_)[2] local function _80_(spec, versions)
 ...
 return gt_3f(a, b) end local function _82_(_241, _242) return satisfies_3f(spec, _242) end return enum.sort(_81_, enum.filter(_82_, versions)) end return _80_ else return nil end else return nil end end table.insert((__fn_2a_solve_dispatch).bodies, _77_) _76_ = solve end local function _85_() table.insert((__fn_2a_solve_dispatch).help, "(where [specs versions] (and (table? specs) (table? versions)))") local function _86_(...) if (2 == select("#", ...)) then local _87_ = {...} local function _88_(...) local specs_64_ = (_87_)[1] local versions_65_ = (_87_)[2] return (table_3f(specs_64_) and table_3f(versions_65_)) end if (((_G.type(_87_) == "table") and (nil ~= (_87_)[1]) and (nil ~= (_87_)[2])) and _88_(...)) then local specs_64_ = (_87_)[1] local versions_65_ = (_87_)[2] local function _89_(specs, versions)
 ...
 local b = str__3ever(_242)
 return gt_3f(a, b) end local function _91_(_241, _242) return (#specs == _242) end local function _92_(_241, _242, _243) return enum["set$"](_241, _243, (1 + ((_241)[_243] or 0))) end local function _93_(_241, _242) return solve(_242, versions) end return enum.sort(_90_, enum.keys(enum.filter(_91_, enum.reduce(_92_, {}, enum.flatten(enum.map(_93_, specs)))))) end return _89_ else return nil end else return nil end end table.insert((__fn_2a_solve_dispatch).bodies, _86_) return solve end do local _ = {_76_, _85_()} end return solve end setmetatable({nil, nil}, {__call = _75_})()
