 ...
 local __fn_2a_subscribe_dispatch = {bodies = {}, help = {}} local subscribe local function _13_(...) if (0 == #(__fn_2a_subscribe_dispatch).bodies) then error(("multi-arity function " .. "subscribe" .. " has no bodies")) else end local _15_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_subscribe_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _15_ = f_78_auto end if (nil ~= _15_) then local f_78_auto = _15_ return f_78_auto(...) elseif (_15_ == nil) then local view_81_auto do local _16_, _17_ = pcall(require, "fennel") if ((_16_ == true) and ((_G.type(_17_) == "table") and (nil ~= (_17_).view))) then local view_81_auto0 = (_17_).view view_81_auto = view_81_auto0 elseif ((_16_ == false) and true) then local __79_auto = _17_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _19_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _19_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "subscribe", table.concat(_19_, ", "), table.concat((__fn_2a_subscribe_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end subscribe = _13_ local function _22_() local function _23_() table.insert((__fn_2a_subscribe_dispatch).help, "(where [topic-id callback] (function? callback))") local function _24_(...) if (2 == select("#", ...)) then local _25_ = {...} local function _26_(...) local topic_id_11_ = (_25_)[1] local callback_12_ = (_25_)[2] return function_3f(callback_12_) end if (((_G.type(_25_) == "table") and (nil ~= (_25_)[1]) and (nil ~= (_25_)[2])) and _26_(...)) then local topic_id_11_ = (_25_)[1] local callback_12_ = (_25_)[2] local function _27_(topic_id, callback)
 ...
 local __fn_2a_unsubscribe_dispatch = {bodies = {}, help = {}} local unsubscribe local function _32_(...) if (0 == #(__fn_2a_unsubscribe_dispatch).bodies) then error(("multi-arity function " .. "unsubscribe" .. " has no bodies")) else end local _34_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_unsubscribe_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _34_ = f_78_auto end if (nil ~= _34_) then local f_78_auto = _34_ return f_78_auto(...) elseif (_34_ == nil) then local view_81_auto do local _35_, _36_ = pcall(require, "fennel") if ((_35_ == true) and ((_G.type(_36_) == "table") and (nil ~= (_36_).view))) then local view_81_auto0 = (_36_).view view_81_auto = view_81_auto0 elseif ((_35_ == false) and true) then local __79_auto = _36_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _38_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _38_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "unsubscribe", table.concat(_38_, ", "), table.concat((__fn_2a_unsubscribe_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end unsubscribe = _32_ local function _41_() local function _42_() table.insert((__fn_2a_unsubscribe_dispatch).help, "(where [topic-id callback] (function? callback))") local function _43_(...) if (2 == select("#", ...)) then local _44_ = {...} local function _45_(...) local topic_id_30_ = (_44_)[1] local callback_31_ = (_44_)[2] return function_3f(callback_31_) end if (((_G.type(_44_) == "table") and (nil ~= (_44_)[1]) and (nil ~= (_44_)[2])) and _45_(...)) then local topic_id_30_ = (_44_)[1] local callback_31_ = (_44_)[2] local function _46_(topic_id, callback)
