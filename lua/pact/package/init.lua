 ...
 local __fn_2a_Package__spec__3epackage_dispatch = {bodies = {}, help = {}} local function _20_(...) if (0 == #(__fn_2a_Package__spec__3epackage_dispatch).bodies) then error(("multi-arity function " .. "Package.spec->package" .. " has no bodies")) else end local _22_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__spec__3epackage_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _22_ = f_78_auto end if (nil ~= _22_) then local f_78_auto = _22_ return f_78_auto(...) elseif (_22_ == nil) then local view_81_auto do local _23_, _24_ = pcall(require, "fennel") if ((_23_ == true) and ((_G.type(_24_) == "table") and (nil ~= (_24_).view))) then local view_81_auto0 = (_24_).view view_81_auto = view_81_auto0 elseif ((_23_ == false) and true) then local __79_auto = _24_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _26_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _26_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.spec->package", table.concat(_26_, ", "), table.concat((__fn_2a_Package__spec__3epackage_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package["spec->package"] = _20_ local function _29_() local _30_ do table.insert((__fn_2a_Package__spec__3epackage_dispatch).help, "(where [[\"git\" spec]])") local function _31_(...) if (1 == select("#", ...)) then local _32_ = {...} local function _33_(...) local spec_18_ = ((_32_)[1])[2] return true end if (((_G.type(_32_) == "table") and ((_G.type((_32_)[1]) == "table") and (((_32_)[1])[1] == "git") and (nil ~= ((_32_)[1])[2]))) and _33_(...)) then local spec_18_ = ((_32_)[1])[2] local function _36_(_34_)
 ...
 local __fn_2a_Package__add_event_dispatch = {bodies = {}, help = {}} local function _61_(...) if (0 == #(__fn_2a_Package__add_event_dispatch).bodies) then error(("multi-arity function " .. "Package.add-event" .. " has no bodies")) else end local _63_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__add_event_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _63_ = f_78_auto end if (nil ~= _63_) then local f_78_auto = _63_ return f_78_auto(...) elseif (_63_ == nil) then local view_81_auto do local _64_, _65_ = pcall(require, "fennel") if ((_64_ == true) and ((_G.type(_65_) == "table") and (nil ~= (_65_).view))) then local view_81_auto0 = (_65_).view view_81_auto = view_81_auto0 elseif ((_64_ == false) and true) then local __79_auto = _65_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _67_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _67_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.add-event", table.concat(_67_, ", "), table.concat((__fn_2a_Package__add_event_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package["add-event"] = _61_ local function _70_() local _71_ do table.insert((__fn_2a_Package__add_event_dispatch).help, "(where [package event])") local function _72_(...) if (2 == select("#", ...)) then local _73_ = {...} local function _74_(...) local package_56_ = (_73_)[1] local event_57_ = (_73_)[2] return true end if (((_G.type(_73_) == "table") and (nil ~= (_73_)[1]) and (nil ~= (_73_)[2])) and _74_(...)) then local package_56_ = (_73_)[1] local event_57_ = (_73_)[2] local function _75_(package, event)
 ...
 local __fn_2a_Package__installed_3f_dispatch = {bodies = {}, help = {}} local function _114_(...) if (0 == #(__fn_2a_Package__installed_3f_dispatch).bodies) then error(("multi-arity function " .. "Package.installed?" .. " has no bodies")) else end local _116_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__installed_3f_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _116_ = f_78_auto end if (nil ~= _116_) then local f_78_auto = _116_ return f_78_auto(...) elseif (_116_ == nil) then local view_81_auto do local _117_, _118_ = pcall(require, "fennel") if ((_117_ == true) and ((_G.type(_118_) == "table") and (nil ~= (_118_).view))) then local view_81_auto0 = (_118_).view view_81_auto = view_81_auto0 elseif ((_117_ == false) and true) then local __79_auto = _118_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _120_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _120_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.installed?", table.concat(_120_, ", "), table.concat((__fn_2a_Package__installed_3f_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package["installed?"] = _114_ local function _123_() local _124_ do table.insert((__fn_2a_Package__installed_3f_dispatch).help, "(where [package] package.git)") local function _125_(...) if (1 == select("#", ...)) then local _126_ = {...} local function _127_(...) local package_112_ = (_126_)[1] return package_112_.git end if (((_G.type(_126_) == "table") and (nil ~= (_126_)[1])) and _127_(...)) then local package_112_ = (_126_)[1] local function _128_(package)
 ...
 local __fn_2a_Package__align_to_target_dispatch = {bodies = {}, help = {}} local function _144_(...) if (0 == #(__fn_2a_Package__align_to_target_dispatch).bodies) then error(("multi-arity function " .. "Package.align-to-target" .. " has no bodies")) else end local _146_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__align_to_target_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _146_ = f_78_auto end if (nil ~= _146_) then local f_78_auto = _146_ return f_78_auto(...) elseif (_146_ == nil) then local view_81_auto do local _147_, _148_ = pcall(require, "fennel") if ((_147_ == true) and ((_G.type(_148_) == "table") and (nil ~= (_148_).view))) then local view_81_auto0 = (_148_).view view_81_auto = view_81_auto0 elseif ((_147_ == false) and true) then local __79_auto = _148_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _150_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _150_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.align-to-target", table.concat(_150_, ", "), table.concat((__fn_2a_Package__align_to_target_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package["align-to-target"] = _144_ local function _153_() do local _ = {} end return Package["align-to-target"] end setmetatable({nil, nil}, {__call = _153_})()
 ...
 local __fn_2a_Package__align_to_checkout_dispatch = {bodies = {}, help = {}} local function _167_(...) if (0 == #(__fn_2a_Package__align_to_checkout_dispatch).bodies) then error(("multi-arity function " .. "Package.align-to-checkout" .. " has no bodies")) else end local _169_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__align_to_checkout_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _169_ = f_78_auto end if (nil ~= _169_) then local f_78_auto = _169_ return f_78_auto(...) elseif (_169_ == nil) then local view_81_auto do local _170_, _171_ = pcall(require, "fennel") if ((_170_ == true) and ((_G.type(_171_) == "table") and (nil ~= (_171_).view))) then local view_81_auto0 = (_171_).view view_81_auto = view_81_auto0 elseif ((_170_ == false) and true) then local __79_auto = _171_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _173_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _173_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.align-to-checkout", table.concat(_173_, ", "), table.concat((__fn_2a_Package__align_to_checkout_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package["align-to-checkout"] = _167_ local function _176_() do local _ = {} end return Package["align-to-checkout"] end setmetatable({nil, nil}, {__call = _176_})()
 ...
 local __fn_2a_Package__discard_dispatch = {bodies = {}, help = {}} local function _190_(...) if (0 == #(__fn_2a_Package__discard_dispatch).bodies) then error(("multi-arity function " .. "Package.discard" .. " has no bodies")) else end local _192_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_Package__discard_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _192_ = f_78_auto end if (nil ~= _192_) then local f_78_auto = _192_ return f_78_auto(...) elseif (_192_ == nil) then local view_81_auto do local _193_, _194_ = pcall(require, "fennel") if ((_193_ == true) and ((_G.type(_194_) == "table") and (nil ~= (_194_).view))) then local view_81_auto0 = (_194_).view view_81_auto = view_81_auto0 elseif ((_193_ == false) and true) then local __79_auto = _194_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _196_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _196_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "Package.discard", table.concat(_196_, ", "), table.concat((__fn_2a_Package__discard_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end Package.discard = _190_ local function _199_() do local _ = {} end return Package.discard end setmetatable({nil, nil}, {__call = _199_})()
