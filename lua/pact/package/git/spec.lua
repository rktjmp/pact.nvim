 ...
 local __fn_2a_make_dispatch = {bodies = {}, help = {}} local make local function _52_(...) if (0 == #(__fn_2a_make_dispatch).bodies) then error(("multi-arity function " .. "make" .. " has no bodies")) else end local _54_ do local f_74_auto = nil for __75_auto, match_3f_76_auto in ipairs((__fn_2a_make_dispatch).bodies) do if f_74_auto then break end f_74_auto = match_3f_76_auto(...) end _54_ = f_74_auto end if (nil ~= _54_) then local f_74_auto = _54_ return f_74_auto(...) elseif (_54_ == nil) then local view_77_auto do local _55_, _56_ = pcall(require, "fennel") if ((_55_ == true) and ((_G.type(_56_) == "table") and (nil ~= (_56_).view))) then local view_77_auto0 = (_56_).view view_77_auto = view_77_auto0 elseif ((_55_ == false) and true) then local __75_auto = _56_ view_77_auto = (_G.vim.inspect or print) else view_77_auto = nil end end local msg_78_auto local _58_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_79_auto = 1, select("#", ...) do local val_19_auto = view_77_auto(({...})[i_79_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _58_ = tbl_17_auto end msg_78_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "make", table.concat(_58_, ", "), table.concat((__fn_2a_make_dispatch).help, "\n")) return error(msg_78_auto) else return nil end end make = _52_ local function _61_() local _62_ do table.insert((__fn_2a_make_dispatch).help, "(where [url opts] (and (string? url) (table? opts)))") local function _63_(...) if (2 == select("#", ...)) then local _64_ = {...} local function _65_(...) local url_50_ = (_64_)[1] local opts_51_ = (_64_)[2] return (string_3f(url_50_) and table_3f(opts_51_)) end if (((_G.type(_64_) == "table") and (nil ~= (_64_)[1]) and (nil ~= (_64_)[2])) and _65_(...)) then local url_50_ = (_64_)[1] local opts_51_ = (_64_)[2] local function _66_(url, opts)
