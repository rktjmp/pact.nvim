 ...
 local __fn_2a_M__satisfies_3f_dispatch = {bodies = {}, help = {}} local function _67_(...) if (0 == #(__fn_2a_M__satisfies_3f_dispatch).bodies) then error(("multi-arity function " .. "M.satisfies?" .. " has no bodies")) else end local _69_ do local f_78_auto = nil for __79_auto, match_3f_80_auto in ipairs((__fn_2a_M__satisfies_3f_dispatch).bodies) do if f_78_auto then break end f_78_auto = match_3f_80_auto(...) end _69_ = f_78_auto end if (nil ~= _69_) then local f_78_auto = _69_ return f_78_auto(...) elseif (_69_ == nil) then local view_81_auto do local _70_, _71_ = pcall(require, "fennel") if ((_70_ == true) and ((_G.type(_71_) == "table") and (nil ~= (_71_).view))) then local view_81_auto0 = (_71_).view view_81_auto = view_81_auto0 elseif ((_70_ == false) and true) then local __79_auto = _71_ view_81_auto = (_G.vim.inspect or print) else view_81_auto = nil end end local msg_82_auto local _73_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_83_auto = 1, select("#", ...) do local val_19_auto = view_81_auto(({...})[i_83_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _73_ = tbl_17_auto end msg_82_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "M.satisfies?", table.concat(_73_, ", "), table.concat((__fn_2a_M__satisfies_3f_dispatch).help, "\n")) return error(msg_82_auto) else return nil end end M["satisfies?"] = _67_ local function _76_() local _77_ do table.insert((__fn_2a_M__satisfies_3f_dispatch).help, "(where [[\"git\" \"commit\" sha] commit])") local function _78_(...) if (2 == select("#", ...)) then local _79_ = {...} local function _80_(...) local sha_54_ = ((_79_)[1])[3] local commit_55_ = (_79_)[2] return true end if (((_G.type(_79_) == "table") and ((_G.type((_79_)[1]) == "table") and (((_79_)[1])[1] == "git") and (((_79_)[1])[2] == "commit") and (nil ~= ((_79_)[1])[3])) and (nil ~= (_79_)[2])) and _80_(...)) then local sha_54_ = ((_79_)[1])[3] local commit_55_ = (_79_)[2] local function _83_(_81_, commit)
