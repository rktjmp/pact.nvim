 ...
 local __fn_2a_solve_constraint_dispatch = {bodies = {}, help = {}} local solve_constraint local function _26_(...) if (0 == #(__fn_2a_solve_constraint_dispatch).bodies) then error(("multi-arity function " .. "solve-constraint" .. " has no bodies")) else end local _28_ do local f_74_auto = nil for __75_auto, match_3f_76_auto in ipairs((__fn_2a_solve_constraint_dispatch).bodies) do if f_74_auto then break end f_74_auto = match_3f_76_auto(...) end _28_ = f_74_auto end if (nil ~= _28_) then local f_74_auto = _28_ return f_74_auto(...) elseif (_28_ == nil) then local view_77_auto do local _29_, _30_ = pcall(require, "fennel") if ((_29_ == true) and ((_G.type(_30_) == "table") and (nil ~= (_30_).view))) then local view_77_auto0 = (_30_).view view_77_auto = view_77_auto0 elseif ((_29_ == false) and true) then local __75_auto = _30_ view_77_auto = (_G.vim.inspect or print) else view_77_auto = nil end end local msg_78_auto local _32_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_79_auto = 1, select("#", ...) do local val_19_auto = view_77_auto(({...})[i_79_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _32_ = tbl_17_auto end msg_78_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "solve-constraint", table.concat(_32_, ", "), table.concat((__fn_2a_solve_constraint_dispatch).help, "\n")) return error(msg_78_auto) else return nil end end solve_constraint = _26_ local function _35_() local _36_ do table.insert((__fn_2a_solve_constraint_dispatch).help, "(where [constraint commits _] (Constraint.version? constraint))") local function _37_(...) if (3 == select("#", ...)) then local _38_ = {...} local function _39_(...) local constraint_17_ = (_38_)[1] local commits_18_ = (_38_)[2] local __19_ = (_38_)[3] return Constraint["version?"](constraint_17_) end if (((_G.type(_38_) == "table") and (nil ~= (_38_)[1]) and (nil ~= (_38_)[2]) and true) and _39_(...)) then local constraint_17_ = (_38_)[1] local commits_18_ = (_38_)[2] local __19_ = (_38_)[3] local function _40_(constraint, commits, _)
 ...
 local __fn_2a_best_commit_or_error_dispatch = {bodies = {}, help = {}} local best_commit_or_error local function _73_(...) if (0 == #(__fn_2a_best_commit_or_error_dispatch).bodies) then error(("multi-arity function " .. "best-commit-or-error" .. " has no bodies")) else end local _75_ do local f_74_auto = nil for __75_auto, match_3f_76_auto in ipairs((__fn_2a_best_commit_or_error_dispatch).bodies) do if f_74_auto then break end f_74_auto = match_3f_76_auto(...) end _75_ = f_74_auto end if (nil ~= _75_) then local f_74_auto = _75_ return f_74_auto(...) elseif (_75_ == nil) then local view_77_auto do local _76_, _77_ = pcall(require, "fennel") if ((_76_ == true) and ((_G.type(_77_) == "table") and (nil ~= (_77_).view))) then local view_77_auto0 = (_77_).view view_77_auto = view_77_auto0 elseif ((_76_ == false) and true) then local __75_auto = _77_ view_77_auto = (_G.vim.inspect or print) else view_77_auto = nil end end local msg_78_auto local _79_ do local tbl_17_auto = {} local i_18_auto = #tbl_17_auto for i_79_auto = 1, select("#", ...) do local val_19_auto = view_77_auto(({...})[i_79_auto]) if (nil ~= val_19_auto) then i_18_auto = (i_18_auto + 1) do end (tbl_17_auto)[i_18_auto] = val_19_auto else end end _79_ = tbl_17_auto end msg_78_auto = string.format(("Multi-arity function %s had no matching head " .. "or default defined.\nCalled with: [%s]\nHeads:\n%s"), "best-commit-or-error", table.concat(_79_, ", "), table.concat((__fn_2a_best_commit_or_error_dispatch).help, "\n")) return error(msg_78_auto) else return nil end end best_commit_or_error = _73_ local function _82_() do local _ = {} end return best_commit_or_error end setmetatable({nil, nil}, {__call = _82_})()
