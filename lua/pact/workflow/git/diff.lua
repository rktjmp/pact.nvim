 ...
 local function _55_() return diff(path, sha) end return new_workflow(id, _55_) end return _54_ else return nil end else return nil end end table.insert((__fn_2a_new_dispatch).bodies, _51_) return new end do local _ = {_50_()} end return new end setmetatable({nil, nil}, {__call = _49_})()
