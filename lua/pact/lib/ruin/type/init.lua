 ...
 local next = _G.next local ruin_type_key = "__ruin__type"
 ...
 local _1_ = getmetatable(value) if ((_G.type(_1_) == "table") and (nil ~= (_1_)[ruin_type_key])) then local dt = (_1_)[ruin_type_key]
 ...
 local _3_ = {v[1], #v, next(v)} if ((_G.type(_3_) == "table") and (nil ~= (_3_)[1]) and true and true) then local not_nil = (_3_)[1] local _ = (_3_)[2] local _0 = (_3_)[3] return true elseif ((_G.type(_3_) == "table") and ((_3_)[1] == nil) and ((_3_)[2] == 0) and ((_3_)[3] == nil)) then return true elseif ((_G.type(_3_) == "table") and ((_3_)[1] == nil) and ((_3_)[2] == 0) and ((_3_)[3] == "n")) then





 return (nil == next(v, "n")) elseif true then local _ = _3_ return false else return nil end else return false end end
